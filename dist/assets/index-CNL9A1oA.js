(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))o(c);new MutationObserver(c=>{for(const s of c)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(c){const s={};return c.integrity&&(s.integrity=c.integrity),c.referrerPolicy&&(s.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?s.credentials="include":c.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(c){if(c.ep)return;c.ep=!0;const s=n(c);fetch(c.href,s)}})();const M=[{id:"jirorin",name:"ジロリン",category:"確認",desc:"たくさんの目で隅々まで確認しようとする…",color:"#B2D8FF",avatarType:"img",avatarSrc:"/Users/torigoe971003/.gemini/antigravity/brain/190f1246-15b7-4c2e-81fa-4fc802532f5a/enemy_jirorin_1773398462646.png",speechLines:["ゆっくり鼻から吸って…","３秒止めて、細く吐こう","周りの音を３つ選んでみて","今、椅子に触れている感覚を…"],defeatMsg:"ジロリンが静まった。心に穏やかな風が吹いている。"},{id:"dororu",name:"ドロル",category:"不潔・洗浄",desc:"全身泥んこ。触るものを全部汚したがる…",color:"#F9D9B0",avatarType:"svg",avatarSvg:`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    ...
    </svg>`,speechLines:["自分の手のひらを見つめて…","指先のあたたかさを感じよう","足の裏が地面に着く感覚…","ゆっくりと、深く呼吸して"],defeatMsg:"ドロルが消えていく。自分自身が守られている安心感。"},{id:"chiguhagu",name:"チグハグ",category:"縁起・儀式",desc:"左右非対称のまま。完璧にしようとしてイライラ…",color:"#E0D0FF",avatarType:"svg",avatarSvg:`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <!-- 足（左右バラバラ） -->
    ...
    </svg>`,speechLines:["目の前のものの形を観察しよう","色のグラデーションを見てみて","肩の力を、すとん、と抜いて","今の自分に「大丈夫」と言おう"],defeatMsg:"チグハグが調和した。不完全なままで完璧なんだ。"},{id:"bosori",name:"ボソリ",category:"加害・不道徳",desc:"耳元でいじわるな囁きをしてくる小さな影…",color:"#C8F5E0",avatarType:"svg",avatarSvg:`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <!-- 影の体（ふわふわした形） -->
    ...
    </svg>`,speechLines:["今、この瞬間に集中しよう","心の中に静かな湖をイメージ","自分のペースで大丈夫だよ"],defeatMsg:`${t}が落ち着いた。あなたは自分を整えることができた。`};l.selectedEnemy=n,d("screen-difficulty"),g()}function g(){const e=i("selected-enemy-preview"),t=l.selectedEnemy;t&&(e.innerHTML=`
